...
import { MapPin, Calendar, Clock, Droplets, Hospital, MessageSquare, User, Mail } from "lucide-react";
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="bg-white rounded-xl shadow-md p-6 md:p-8">
                        <div className="flex items-start justify-between mb-6">
                            <h1 className="text-3xl font-bold text-gray-800">{request.recipientName}</h1>
                        ...
                        <div className="mb-6">
                            <div className="flex items-center gap-3 mb-2">
                                <Hospital className="text-indigo-600" size={24} />
                                <h3 className="text-lg font-semibold">Hospital</h3>
                            </div>
                            <p className="text-gray-700 ml-9">{request.hospitalName}</p>
                            <p className="text-gray-600 ml-9 text-sm">{request.address}</p>
                        </div>
                        ...
                        {request.message && (
                            <div className="mb-6">
                                ...
                                <p className="text-gray-700 ml-9">{request.message}</p>
                            </div>
                        )}
