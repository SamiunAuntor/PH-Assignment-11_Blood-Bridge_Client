                            ...
                            {requests.map((r) => (
                                ...
                                >
                                    ...
                                    <td className="px-4 py-3 border border-gray-200">
                                        <span
                                            className={`px-2 py-0.5 rounded-sm text-[10px] font-bold border inline-block ${statusStyle(
                                                r.status
                                            )}`}
                                        >
                                            {r.status}
                                    ...
                                    <td className="px-4 py-3 border border-gray-200">
                                        <div className="flex items-center justify-center gap-1">
                                            <Link
                                                ...
                                                className="p-1.5 border border-gray-200 rounded-sm hover:bg-gray-100"
                                            >
                                                <Eye size={14} />
                                            </Link>
                                            ...
                                            {role === "admin" && (
                                                <>
                                                    <Link
                                                        ...
                                                        className="p-1.5 border border-gray-200 rounded-sm hover:bg-gray-100 text-blue-600"
                                                    >
                                                        <Edit3 size={14} />
                                                    </Link>
                                                    <button
                                                        onClick={() => handleDelete(r._id)}
                                                        className="p-1.5 border border-gray-200 rounded-sm hover:bg-gray-100 text-red-600"
                                                    >
                                                        <Trash2 size={14} />
                                                    </button>
                                                </>
                                            ...
                                            {/* Admin & Volunteer: status buttons only if inprogress */}
                                            {(role === "admin" || role === "volunteer") &&
                                                r.status === "inprogress" && (
                                                    <div className="flex gap-1 ml-1 border-l pl-1 border-gray-200">
                                                        <button
                                                            onClick={() => handleStatusUpdate(r._id, "done")}
                                                            className="p-1.5 bg-green-600 text-white rounded-sm hover:bg-green-700"
                                                        >
                                                            <CheckCircle size={14} />
                                                        </button>
                                                        <button
                                                            onClick={() =>
                                                                handleStatusUpdate(r._id, "canceled")
                                                            }
